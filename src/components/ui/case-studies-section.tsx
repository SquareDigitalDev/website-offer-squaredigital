...
export const CaseStudiesSection = () => {
  ...
  return <section id="case-studies" className="py-16 px-6 bg-background">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <div className="flex items-center justify-center gap-4 mb-8">
            <div className="text-lg animate-pulse text-primary font-semibold">
              LIMITED TIME OFFER
            </div>
        ...
        <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
          {websiteMockups.map(mockup => <Card key={mockup.id} className="overflow-hidden group hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <div className="relative h-64 overflow-hidden">
                <img src={mockup.image} alt={`${mockup.title} website mockup`} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
              ...
              <CardContent className="p-6">
                ...
                <Button variant="outline" className="w-full group-hover:bg-primary group-hover:text-primary-foreground transition-colors" onClick={() => window.open('https://www.squaredigital.com/portfolio/', '_blank')}>
                  See Portfolio
                </Button>
              </CardContent>
            </Card>)}
        ...
        <div className="text-center mt-12">
          <Button size="lg" className="text-lg px-8 py-6" onClick={() => window.open('https://squaredigital.typeform.com/to/MlCmyZ5t?typeform-source=a0ca6f58-535c-4753-942d-13e5d2cec672.lovableproject.com', '_blank')}>
            Get Started
          </Button>
        </div>
      </div>
